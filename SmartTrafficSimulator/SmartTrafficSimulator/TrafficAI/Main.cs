...
namespace signalAI
{
    class MainClass
    {
        static void test(string[] args)
        {
            ...
            GA_Optimization proj = new GA_Optimization();
            ...
            intersection.Add(road1);
            intersection.Add(road2);
            intersection.Add(road3);
            intersection.Add(road4);

            settime = proj.GAOptimize(intersection);
