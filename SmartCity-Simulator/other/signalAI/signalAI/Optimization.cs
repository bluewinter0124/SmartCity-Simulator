...
namespace signalAI
{
    ...
    class Optimization
    {
        public List<int> GA(List<double[]> intersection1)
        {
            ...
            int list_length=intersection1.Count;
            int i,a=0,b=0;
            ...
            for (i = 0; i < list_length; i++)
            {
                ...
                if (i % 2 == 0)
                {
                    direction[a].id = (int)intersection1[i][0];
                    direction[a].vector = (int)intersection1[i][1];
                    direction[a].PreGtA = (int)intersection1[i][2];
                    direction[a].PreGtB = (int)intersection1[i][3];
                    direction[a].Qright = intersection1[i][4];
                    direction[b].AvgUp = intersection1[i][5];
                }
                else
                {
                    direction[a].PreGtC = (int)intersection1[i][3];
                    direction[a].Qleft = intersection1[i][4];
                    direction[b].AvgDown = intersection1[i][5];
                }
            }

            //Console.WriteLine(direction[0].id + " " + direction[0].vector + " " + direction[0].Qright + " " + direction[0].Qleft + " " + direction[0].AvgUp + " " + direction[0].AvgDown + " " + direction[0].PreGtA + " " + direction[0].PreGtB + " " + direction[0].PreGtC);
            //Console.WriteLine(direction[1].id + " " + direction[1].vector + " " + direction[1].Qright + " " + direction[1].Qleft + " " + direction[1].AvgUp + " " + direction[1].AvgDown + " " + direction[1].PreGtA + " " + direction[1].PreGtB + " " + direction[1].PreGtC);
            //Console.ReadLine();
